...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                options=[{'label': 'All Sites', 'value': 'ALL'},{'label': launch_site[0], 'value': launch_site[0]}, {'label': launch_site[1], 'value': launch_site[1]}, {'label': launch_site[2], 'value': launch_site[2]},{'label': launch_site[3], 'value': launch_site[3]}],
                                value='ALL',
